...
using GivingBack.GivingBackCode.Extensions;
using MegaCrit.Sts2.Core.Entities.Powers;

namespace GivingBack.GivingBackCode.Powers;
...
/// </summary>
public abstract class GivingBackPower : CustomPowerModel
{
    //Loads from GivingBack/images/powers/your_power.png
